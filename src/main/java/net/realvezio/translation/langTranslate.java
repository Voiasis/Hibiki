...
public class langTranslate {
    ...
    public static void reactTranslate(MessageReactionAddEvent event) {
        if (event.getUserId().equals("835691330725347379")) {
            ...
            if (event.getEmoji().getAsReactionCode().equals("pixel_x:802670461321347113")) {
                if (event.getGuild().getMemberById("1010933365555335248").hasPermission(Permission.MESSAGE_MANAGE)) {
