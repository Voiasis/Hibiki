...
public class prefixStop {
    public static void stop(Message message) {
        if (message.getAuthor().getId().equals("472899069136601099")) {
            message.getJDA().getGuildById("902397621015040020").getTextChannelById("953515276144619601").sendMessage("<@472899069136601099>, " + message.getAuthor().getAsTag() + " has used stop!")
            .queue(m -> {
