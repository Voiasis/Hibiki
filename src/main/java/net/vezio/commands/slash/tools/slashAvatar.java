...
public class slashAvatar extends CommandBuilder {
    public slashAvatar() {
        setCommandData(Commands.slash("avatar", "Lists users current activities.").addOption(OptionType.USER, "user", "Who to check activities from.", false));
    }
    @Override
